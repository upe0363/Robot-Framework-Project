...
*** Test Cases ***
Test Case to demoatrate List Operation Keywords in Robot FW
    [Documentation]    Test Case to demostrate List Operation Keywords In Robot FW

    Open Browser  ${url}   ${browser}
    Maximize Browser Window
    Sleep  2s
    Scoll Element Into View    xpath://*[@id="field1"]/div/input
    ...
    ${ListLabe}=    Get Selected List Label    xpath://*[@id="field27"]/div/select
...
#   Multiselect lists
    ...
    Sleep  2s
    Unslectn From List By Index  xpath://*[@id="cars"]   1
    Sleep  2s
    ...
    Sleep   2s
    List Should Have No Selections  xpath://*[2id="cars"]
